...
namespace em::Math::VectorOps
{
    ...
    #define DETAIL_EM_VEC_UNARY_OP(name_, op_, ...) \
        ...
        [[nodiscard]] EM_TINY constexpr auto operator op_(A &&a) EM_RETURNS((apply_elementwise_nontrivial)(Ops::name_{}, EM_FWD(a)))
    ...
    #define DETAIL_EM_VEC_BINARY_OP(name_, op_, ...) \
        ...
        [[nodiscard]] EM_TINY constexpr auto operator op_(A &&a, B &&b) EM_RETURNS((apply_elementwise_nontrivial)(Ops::name_{}, EM_FWD(a), EM_FWD(b))) \
        /* Assignment. */\
        template <typename A, typename B> requires(_adl_em_vec_allow_operator(Ops::name_{}, Meta::Tag<A &&>{}, Meta::Tag<B &&>{})) \
        EM_TINY constexpr auto operator EM_CAT(op_,=)(A &&a, B &&b) EM_RETURNS((void((apply_elementwise_nontrivial)(Ops::EM_CAT(name_, Assign){}, EM_FWD(a), EM_FWD(b))), a))
    ...
    [[nodiscard]] EM_TINY constexpr auto operator==(const A &a, const B &b) EM_RETURNS(!(any_of_elementwise_same_kind_nontrivial)(NotEqual{}, a, b))
}
